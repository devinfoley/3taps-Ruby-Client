# Class GeocoderClient represents server request of geocoding API.
# GeocoderClient calculate the location to use for a posting based on
# location-specific details within the posting such as a street address or
